"""
Django settings for ubctest_91 project.
...
WSGI_APPLICATION = 'ubctest_91.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ubctest_91 API",
    "DESCRIPTION": "API documentation for ubctest_91 App",
    "VERSION": "v1",
}
